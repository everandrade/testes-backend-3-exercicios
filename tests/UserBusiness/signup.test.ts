...
describe("signup", () => {
    ...
    test("testar name se é string", async () => {
        expect.assertions(2)
        const input: SignupInputDTO = {
            email: "example@email.com",
            name: null,
    ...
    test("testar password se é string", async () => {
        expect.assertions(2)
        const input: SignupInputDTO = {
    ...
    test("testar email se já está cadastrado", async () => {
        const input: SignupInputDTO = {
            email: "normal@email.com",
            name: "Normal Mock",
        ...
        expect(result).rejects.toThrow("'email' já existe")
    })
})